...
export default function Perfil() {
  ...
  const abaBtnCls = (aba) => `flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
    abaAtiva === aba ? 'bg-primary-500/20 text-primary-400 border border-primary-500/30' : 'bg-fundo-card text-texto-secundario border border-borda hover:border-primary-500/30'
  }`;
